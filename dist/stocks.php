...
<html lang="en">
    ...
    <body onload="realtimeClock()">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0"> 
                        ...
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="stocks.php">Stocks</a></li>
        ...
        <header class="py-2" id="header">
            <div class="container">
                <div class="text-center" class="bg-image bg-opacity-10" style="background-image: url('../images/stocks.jpg'); height: 400px;">
                </div>
            </div>
        </header>
        <!-- Page content-->
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <form id="searchForm" class="col-md-12" action="<?php echo htmlspecialchars('stocks.php', ENT_QUOTES); ?>" method="post">
                                    ...
                                    <div class="col-md-12 text-center mt-3">
                                        ...
                                        <a href="http://localhost/semestralny_projekt_dsd_paloriso/dist/stocks.php"class="col-md-6"><button class="btn btn-primary" id="button-search" type="submit" name="searchButton" >Show all posts</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col-sm-12">
                                <a href="createPost.php?category=stocks"><button class="btn btn-primary" id="button-search" type="button">Create new post</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
