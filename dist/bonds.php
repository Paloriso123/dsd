                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="input-group">
                                <form id="searchForm" class="col-md-12" action="<?php echo htmlspecialchars('bonds.php', ENT_QUOTES); ?>" method="post">
                                    ...
                                    <div class="col-md-12 text-center mt-3">
                                        ...
                                        <a href="http://localhost/semestralny_projekt_dsd_paloriso/dist/bonds.php"class="col-md-6"><button class="btn btn-primary" id="button-search" type="submit" name="searchButton" >Show all posts</button></a>
                                    </div>
                                </form>
                            </div>
                        </div>
